...
//Títulos botones:
const urlButtonText = "INTRODUCE URL";
...
watch(urlValue, (value) => {
  if (urlValue.value && urlValue.value.length > 0) {
    if (isValidURL(value)) {
      ...
      <div name="FirstButton">
        ...
        >
          ...
          <p
            ...
            v-show="!urlValueIsURL && urlValue.length > 0"
          >
            Tiene que ser una URL (Ej: "https://www...")
          </p>
        </DropdownButton>
      </div>
