...
const finalText = computed(() => {
  ...
  final += "TEL:" + tel1.value.toString() + ";\n";
  final += "TEL:" + tel2.value.toString() + ";\n";
  final += "TEL:" + tel3.value.toString() + ";\n";
  final += addressText.value + ";\n";
  final += "EMAIL:" + email.value + ";\n";
  final += "BDAY:" + birthdate.value + ";\n";
        ...
        <div name="FirstButton">
          ...
          >
            ...
            >
              ...
              <div>
                <p class="pb-2"><b>Apodo</b></p>
                <input
                  v-model="nickname"
                  type="text"
                  class="custom-input"
                  placeholder="Introducir apodo"
                />
              </div>
              <div>
              ...
              <div>
                <p class="pb-2"><b>Fecha de nacimiento</b></p>
                <input
                  v-model="birthdate"
                  type="date"
                  class="custom-input"
