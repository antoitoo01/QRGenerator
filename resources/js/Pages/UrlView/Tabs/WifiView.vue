    ...
    <div name="MainContainer" class="flex flex-col size-full pr-2">
      ...
      <div name="FirstButton">
        ...
        >
          ...
          >
            <div>
              <p class="pb-2"><b>SSID</b></p>
              <input
                v-model="ssid"
                type="text"
                class="custom-input"
                placeholder="Introducir SSID"
              />
            </div>
            <div>
              <p class="pb-2"><b>Contraseña</b></p>
              <input
                v-model="pwd"
                type="text"
                class="custom-input"
            ...
            <div>
              <p class="pb-2"><b>Encriptación</b></p>
              <select v-model="type" class="custom-input">
                <option value="">Sin encriptar</option>
