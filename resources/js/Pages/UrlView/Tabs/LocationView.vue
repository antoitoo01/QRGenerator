<script setup>
import { ref, watch, computed, defineProps, watchEffect } from "vue";
...
import Map from "../../../Components/My_components/Map.vue";
...
const latitude = ref(36.43);
const longitude = ref(-5.45);

const finalText = computed(() => {
  let final = "geo:";
  final += latitude.value + ",";
  final += longitude.value;
  return final;
});
        ...
        >
          ...
          >
            <div class="grid col-span-full">
              <Map v-model:lat="latitude" v-model:lon="longitude" />
            </div>
            <div>
              <p class="pb-2"><b>Latitud</b></p>
              <input
                v-model="latitude"
                type="text"
                class="custom-input"
                placeholder="Introducir latitud"
              />
            </div>
            <div>
              <p class="pb-2"><b>Longitud</b></p>
              <input
                v-model="longitude"
                type="text"
                class="custom-input"
                placeholder="Introducir longitud"
              />
            </div>
          </div>
        </DropdownButton>
