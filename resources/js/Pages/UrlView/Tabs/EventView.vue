...
const finalText = computed(() => {
  let final = "BEGIN:VEVENT" + "\n";
  final += "SUMMARY:" + eventTitle.value + "\n";

  const startDateTime = formatDate(new Date(startTime.value));
  const endDateTime = formatDate(new Date(endTime.value));

  final += "DTSTART:" + startDateTime + "\n";
  final += "DTEND:" + endDateTime + "\n";
  final += "LOCATION:" + eventLocation.value + "\n";
  final += "DESCRIPTION:" + description.value + "\n";
  final += "END:VEVENT";
  return final;
});
    ...
    <div name="MainContainer" class="flex flex-col size-full pr-2">
      ...
      >
        <!--
          ...
          -->
        <div>
          <p class="pb-2"><b>Título del evento</b></p>
          <input
            v-model="eventTitle"
            type="text"
            class="custom-input"
            placeholder="Introducir título del evento"
          />
        </div>
        <div>
          <p class="pb-2"><b>Fecha de inicio</b></p>
          <input
            v-model="startTime"
            type="datetime-local"
            class="custom-input"
        ...
        <div>
          <p class="pb-2"><b>Fecha de fin</b></p>
          <input
            v-model="endTime"
            type="datetime-local"
            class="custom-input"
        ...
        <div>
          <p class="pb-2"><b>Localización</b></p>
          <input
        ...
        <div>
          <p class="pb-2"><b>Descripción</b></p>
          <input
            v-model="description"
            type="text"
            class="custom-input"
            placeholder="Introducir descripción del evento"
          />
        </div>
        <!--
          </div>
      ...
      >
        ...
        <div class="flex flex-row place-content-start overflow-auto">
          ...
          <div class="flex flex-col place-items-center">
            ...
            <br />
            <div v-if="eyesIsChecked" class="flex flex-row place-items-center">
              <ColorPicker
                class="flex flex-col"
